    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dechargerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if(containerId.getText().toString().equals("") ||  poids.getText().toString().equals("") || contenu.getText().toString().equals("") || societe.getText().toString().equals("") || dangers.getText().toString().equals(""))
                    {
                        AfficheToast.Affiche("Champs vide !",context);
                    }
                    else
                    {
                        if(capacite > 0)
